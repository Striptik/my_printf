/*
** main.c for main de test in /home/loisel_k/travail/Systeme-Unix/my_printf/src
** 
** Made by kevin loiseleur
** Login   <loisel_k@epitech.net>
** 
** Started on  Sat Nov 16 15:19:16 2013 kevin loiseleur
** Last update Sun Nov 17 18:18:29 2013 kevin loiseleur
*/
...
int		t = 16;
 ...
 str1 = "merde alors";
  ...
  if (ac == 1)
    my_putstr("MET L'ARGUMENT CONNARD !!");
  else
    {
      res = my_printf("%p\n%p\n" , av[1], str1);
      res1 = printf("%p\n%p\n", av[1], str1);
    }
  my_printf("Il y a %d characteres imprimes !\n", res);
  printf("\nIl y a %d characteres imprimes !\n", res1);
  ...
  ret[0] = my_printf("=>  Test de la valeur de retour [-10+d s] : {%+-10d} {%s}\n", 12345, str);
